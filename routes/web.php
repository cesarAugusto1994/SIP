...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('status')->middleware('visitor')->group(function () {
        ...
        Route::prefix('admin')->group(function () {
          ...
          Route::get('employees/{id}/occupation/change', 'EmployeesController@changeOccupation')->name('employee_occupation_change');
          Route::post('employees/{id}/occupation/change/store', 'EmployeesController@changeOccupationStore')->name('employee_occupation_change_store');
