...
<div class="page-body">
  <div class="card">
      <div class="card-header">
          <h5>Editar Categoria de Chamado</h5>
      </div>
      <div class="card-block">

        <form class="formValidation" method="post" method="post" action="{{route('ticket-type-categories.update', $category->uuid)}}">
            @csrf
            {{ method_field('PUT') }}
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="js-switch" type="checkbox" value="1" name="active" {{ $category->active ? 'checked' : '' }}>
