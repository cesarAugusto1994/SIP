            ...
            <div class="row m-b-30">
                ...
                <div class="col-md-4">
                    <div class="form-group {!! $errors->has('document') ? 'has-error' : '' !!}">
                        ...
                        <div class="input-group">
                            <input type="text" id="document" name="document" required value="{{ $client->document }}" class="form-control" placeholder="Informe o CPF ou CNPJ">
                        </div>
                ...
                <div class="col-md-4">
                  <div class="form-group {!! $errors->has('deliver_documents') ? 'has-error' : '' !!}">
                      ...
                      <div class="input-group">
                          <input class="js-switch" type="checkbox" id="deliver_documents" name="deliver_documents" data-plugin="switchery" {{ $client->deliver_documents ? 'checked' : '' }} value="{{ 1 }}">
                      </div>
