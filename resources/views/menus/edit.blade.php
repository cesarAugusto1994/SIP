...
<div class="page-body">
  ...
  <div class="card">
      <div class="card-header">
          <h5>Editar Menu {{ $menu->title }}</h5>
      </div>
      <div class="card-block">

        <form class="formValidation" data-parsley-validate method="post" enctype="multipart/form-data" action="{{route('menus.update', $menu->id)}}">
            @csrf
            {{ method_field('PUT') }}
            <div class="row m-b-30">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" required name="title" value="{{ $menu->title }}" class="form-control">
                      </div>
                  </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" required name="icon" value="{{ $menu->icon }}" class="form-control">
                      </div>
                  </div>
