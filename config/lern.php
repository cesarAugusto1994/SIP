...
return [
    ...
    'notify'=>[
         ...
         */
        'mail'=>[
            'to'   => 'cesar.sousa@provider-es.com.br',
            'from' => 'notificacao@provider-es.com.br',
            'smtp' => true,
        ],
         ...
         */
        'slack'=>[
            'token'   => env('SLACK_APP_TOKEN', '8FxxPYMFGuArUgXlhWJA4ncF'), //https://api.slack.com/web#auth
            'channel' => env('SLACK_CHANNEL', '#notificacoes'), //Dont forget the '#'
