...
class DeliveryOrder extends Model
{
    ...
    protected $fillable = ['status_id', 'client_id', 'amount', 'delivered_by', 'finished_at', 'finished_by', 'address_id', 'delivered_at', 'delivery_date', 'receipt', 'annotations', 'delivery_date'];
